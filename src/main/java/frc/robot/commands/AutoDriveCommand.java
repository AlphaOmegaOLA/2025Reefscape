...
{
    /*
    private final SwerveMod swerveMod;
    private final Translation2d direction;
    private final double speed;
    private final double time;
    private final Timer timer = new Timer();

    public AutoDriveCommand(SwerveMod swerveMod, String directionStr, double distanceInches, double timeSeconds)
    {
        this.swerveMod = swerve;
